...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "MineCraft-Like", NULL, NULL);
    if (window == NULL)
    {
    ...
    graphicManager.Load(window,SCR_WIDTH,SCR_HEIGHT);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //render
        graphicManager.Draw(SCR_WIDTH, SCR_HEIGHT, fov, cameraPos, cameraFront, cameraUp, window,chunkManager);
    }
